...
class CategoryDealsScreen extends StatefulWidget {
  static const String routeName =
      '/category-deals'; //used in widgets/top_categories and register in route.dart
  final String category; // called in appBar
...
class _CategoryDealsScreenState extends State<CategoryDealsScreen> {
  List<Product>? productList; // this is from home_services
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: Text(
            widget.category, //constructor at top
